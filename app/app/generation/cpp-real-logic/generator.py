    ...
    def _generate_impl(self, schema: dict) -> None:
        ...
        for encoded_type in schema['types']:
            ...
            if encoded_type['token'] == 'type':
                ...
                self.generate_document(f'v2.{document_name}', 'composite_v2.tmpl', type=encoded_type, schema=schema,
                                       includes=self.generate_includes_for_composite(encoded_type))
                ...
                self.generate_document(f'v2.{document_name}', 'enum_v2.tmpl', type=encoded_type, schema=schema)
                ...
                self.generate_document(f'v2.{document_name}', 'set_v2.tmpl', type=encoded_type, schema=schema)
