...
class GeneratorBase(ABC):
    ...
    def generate(self, schema: Schema, package: Optional[str] = None) -> None:
        ...
        # Some util types
        ir['utils'] = {
            'block_length' : GeneratorBase.make_encoded_type_definition(schema.header_type.find_type('blockLength')),
            'template_id': GeneratorBase.make_encoded_type_definition(schema.header_type.find_type('templateId')),
            'schema_id' : GeneratorBase.make_encoded_type_definition(schema.header_type.find_type('schemaId')),
            'version': GeneratorBase.make_encoded_type_definition(schema.header_type.find_type('version'))
        }
